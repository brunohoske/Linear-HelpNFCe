...
{
    public partial class InsertLogVendaFin : Form
    {
        public InsertLogVendaFin()
        {
            InitializeComponent();
        }
        ...
        private void InsertLogVendaFin_Load(object sender, EventArgs e)
        {
        ...
        private void btnExecute_Click(object sender, EventArgs e)
        {
            ...
            {
                if (command.InserirLogVendaFin(lj, dt, date, cx, nfce))
                {
            ...
            else if (vNfce == true && sequencia == false)
            {
                ...
                {
                    if (command.InserirLogVendaFin(lj, dt, date, cx, qntNfce[i]))
                    {
            ...
            else if (sequencia = true && vNfce == false)
            {
                ...
                if (command.InserirSequenciaLogVendaFin(lj, dt, date, cx, nfceIni, nfceFin))
                {
